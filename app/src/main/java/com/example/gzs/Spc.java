...
public class Spc extends AppCompatActivity {
    Button b1,b2;
    EditText e1,e2,e3;
    CheckBox c1;
    TextView t1;
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(s4.contentEquals(s3)){
                    Intent i=new Intent(Spc.this,spchome.class);
                    startActivity(i);
                }
                else{
                    Toast.makeText(Spc.this, "invalid password", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    public void getData(){
        ...
        sb.append(Config.DATA_URL2+s1);
        rq.add(new StringRequest(sb.toString(), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Toast.makeText(Spc.this, "Data FETCHED", Toast.LENGTH_SHORT).show();
                ShowJson(response);
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Spc.this, "Data Not Fetched", Toast.LENGTH_SHORT).show();
            }
        }));
    }
