...
public class showtpo extends AppCompatActivity {
    EditText e1;
    String s1,s2,s3;
    Button b1;
    TextView t1,t2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_showtpo);
    ...
    public void getData(){
        ...
        sb.append(Config.DATA_URL8+s1);
        rq.add(new StringRequest(sb.toString(), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Toast.makeText(showtpo.this, "Data FETCHED", Toast.LENGTH_SHORT).show();
                ShowJson(response);
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(showtpo.this, "Data Not Fetched", Toast.LENGTH_SHORT).show();
            }
        }));
    }
